...
class CentroEducativoSerializador(serializers.ModelSerializer):
...
class CentroEducativoListSerializador(serializers.ModelSerializer):
    
    link = serializers.HyperlinkedIdentityField(view_name='centroeducativo-detail', format='html')
